...
### **🏛️ Chapter One: Bond Pricing and a First Look at the Term Structure Of Interest Rates**

Bond pricing is founded on two core principles:

1. **⚖️ The Arbitrage Principle:** This principle asserts that the value of bonds making multiple payments (like coupons) is equal to the value of a portfolio of single-payment bonds, known as zero-coupon bonds. This portfolio is structured to replicate the payment schedule of the multi-payment bond.  
