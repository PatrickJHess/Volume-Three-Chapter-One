...
* 💰 Financial concepts
  ...
  * 🏛️ The term structure and the state of financial markets
...
* [**🐼 Pandas** is introduced *A Quick Introduction to Pandas*](https://patrickjhess.github.io/Introduction-To-Python-For-Financial-Python/An_Introduction_To_Pandas.html#a-quick-introduction-to-pandas) 

* [**🧮 NumPy is introduced** *A Quick Introduction to NumPy*](https://patrickjhess.github.io/Introduction-To-Python-For-Financial-Python/An_Introduction_To_Pandas.html#)
...
* [📚 Additional relevant Python concepts](https://github.com/PatrickJHess/Introduction-To-Python-For-Financial-Python/actions/runs/25677654982)
...
3. **📉 The Jupyter notebook Calculating and Graphing the Term Structure** uses NumPy and Pandas to:
        ...
        * complete an exercise asking you to calculate and plot spot and forward rates with data downloaded from the US Treasury.
